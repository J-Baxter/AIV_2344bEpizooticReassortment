...
def main():
    ...
    with open(shell_filename, "w") as file:
        ...
        file.write('#$ -l h_vmem=32G\n')
        file.write('#$ -l h_rt=300:00:00\n')
        file.write('#$ -l rl9=FALSE\n')
        ...
        file.write("echo 'Start BEAST with AIV data this is a 160 hour run'\n")
        file.write('beast -overwrite -threads 4 -beagle_thread_count 4 '+ xml_filename + '_1.xml' + ' \n')
        file.write('beast -overwrite -threads 4 -beagle_thread_count 4 '+ xml_filename + '_2.xml' + ' \n')
        file.write('logcombiner -trees -burnin 20000000 -resample 360000 ' +  xml_filename + '_1.trees ' + xml_filename + '_2.trees ' + xml_filename + '_1000.trees ' + '\n')
        file.write('logcombiner -trees -burnin 20000000 ' +  xml_filename + '_1.trees ' + xml_filename + '_2.trees ' + xml_filename + '.trees ' + '\n')
        file.write('# \n')
        file.write("# Combine Logfiles\n")
        file.write('logcombiner -burnin 20000000 ' + xml_filename + '_1.log ' + xml_filename + '_2.log ' + xml_filename + '.log ' + '\n')
        file.write('treeannotator -burnin 0 -heights median ' + xml_filename + '.trees ' + xml_filename + '_mcc.tree' + ' \n')
