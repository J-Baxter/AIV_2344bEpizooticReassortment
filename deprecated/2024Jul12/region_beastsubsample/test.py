...
def main():
    ...
    shell_filename = re.sub('_1.xml$', '.sh', relative_path)
    ...
    with open(shell_filename, "w") as file:
        ...
        file.write('parallel beast -seed -overwrite ::: '+ xml_filename + ' ' + re.sub('_1.xml$', '_2.xml', xml_filename) + ' \n')
        file.write('logcombiner -burnin 10000000 -trees -resample 100000 ' + re.sub('.xml$', '.trees', xml_filename)+ ' ' + re.sub('_1.xml$', '_2.trees', xml_filename) + ' -o ' + re.sub('_1.xml$', '_combined.trees', xml_filename)+'\n')
        file.write('logcombiner -burnin 10000000 -resample 100000 ' + re.sub('.xml$', '.log', xml_filename)+ ' ' + re.sub('_1.xml$', '_2.log', xml_filename) + ' -o ' + re.sub('_1.xml$', '_combined.log', xml_filename)+'\n')
